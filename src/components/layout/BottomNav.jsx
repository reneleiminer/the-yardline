...
export default function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none bg-[#013369] px-3"
      style={{ paddingBottom: "calc(10px + env(safe-area-inset-bottom))" }}
      aria-label="Hauptnavigation"
    >
      <div className="absolute inset-0 pointer-events-none border-t border-white/10 bg-[#013369]" />
