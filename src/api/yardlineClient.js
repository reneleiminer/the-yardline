...
const ENTITY_COLUMNS = {
  ...
  NotificationSettings: new Set([
    ...
    'final_scores_enabled',
    'game_reminders_enabled',
    'news_enabled',
    'push_enabled',
    'transfers_enabled',
    'created_at',
...
const NULLABLE_FOREIGN_KEY_COLUMNS = {
  ...
  Comment: new Set(['post_id', 'author_id']),
  Follow: new Set(['follower_id', 'target_id']),
  LeagueFollow: new Set(['user_id', 'league_id']),
  Like: new Set(['post_id', 'user_id']),
  ModerationLog: new Set(['target_user_id', 'target_id', 'moderator_id']),
  Notification: new Set(['user_id', 'target_id']),
  NotificationSettings: new Set(['user_id']),
  RoleApplication: new Set(['user_id', 'requested_team_id', 'requested_league_id', 'reviewed_by']),
  SupportRequest: new Set(['user_id', 'requested_team_id', 'requested_league_id', 'reviewed_by']),
  SupportTicket: new Set(['user_id', 'target_id']),
  League: new Set([]),
